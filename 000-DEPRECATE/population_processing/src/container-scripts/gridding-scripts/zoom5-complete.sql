/*
    ...
    Grids the zoom 5 of population
...
drop table if exists temp.pob_zoom5_gridding;


-- Creates the temp data

create table temp.pob_zoom5_gridding as
...
from
    ...
    context_grid.zoom5 a inner join
