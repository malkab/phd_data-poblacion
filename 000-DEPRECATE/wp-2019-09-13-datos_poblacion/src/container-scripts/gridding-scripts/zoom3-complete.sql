<<<<<<< HEAD
-- Full gridding of poblacion, zoom 3

=======
/*

    Grids the zoom 3 of population
...
create table poblacion_processing.grid_ieca_agg_zoom3 as
select
...
create index grid_ieca_agg_zoom3_geom_gist
on poblacion_processing.grid_ieca_agg_zoom3
using gist(geom);
...
create table poblacion_processing.grid_ieca_agg_zoom3_json as
select
...
from
    poblacion_processing.grid_ieca_agg_zoom3 a inner join
    context_grid.zoom3 b
    on a.cell_gid = b.gid;

create index grid_ieca_agg_zoom3_json_cell_gid
on poblacion_processing.grid_ieca_agg_zoom3_json
...
drop table if exists temp.pob_zoom3_gridding;


-- Creates the temp data

create table temp.pob_zoom3_gridding as
...
from
    ...
    context_grid.zoom3 a inner join
...
from poblacion_processing.grid_ieca_agg_zoom3_json;
=======
        dat0
    )::cell__cell
))
