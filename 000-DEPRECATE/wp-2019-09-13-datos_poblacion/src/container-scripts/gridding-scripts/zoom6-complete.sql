<<<<<<< HEAD
-- Full gridding of poblacion, zoom 6

=======
/*

    Grids the zoom 6 of population
...
create table poblacion_processing.grid_ieca_agg_zoom6 as
select
...
create index grid_ieca_agg_zoom6_geom_gist
on poblacion_processing.grid_ieca_agg_zoom6
using gist(geom);
...
create table poblacion_processing.grid_ieca_agg_zoom6_json as
select
...
from
    poblacion_processing.grid_ieca_agg_zoom6 a inner join
    context_grid.zoom6 b
    on a.cell_gid = b.gid;

create index grid_ieca_agg_zoom6_json_cell_gid
on poblacion_processing.grid_ieca_agg_zoom6_json
...
drop table if exists temp.pob_zoom6_gridding;


-- Creates the temp data

create table temp.pob_zoom6_gridding as
...
from
    ...
    context_grid.zoom6 a inner join
...
from poblacion_processing.grid_ieca_agg_zoom6_json;
=======
        dat0
    )::cell__cell
))
