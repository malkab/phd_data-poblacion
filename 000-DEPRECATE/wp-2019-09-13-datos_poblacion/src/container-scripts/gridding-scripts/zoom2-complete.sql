<<<<<<< HEAD
-- Full gridding of poblacion, zoom 2

=======
/*

    Grids the zoom 2 of population
...
create table poblacion_processing.grid_ieca_agg_zoom2 as
select
...
create index grid_ieca_agg_zoom2_geom_gist
on poblacion_processing.grid_ieca_agg_zoom2
using gist(geom);
...
create table poblacion_processing.grid_ieca_agg_zoom2_json as
select
...
from
    poblacion_processing.grid_ieca_agg_zoom2 a inner join
    context_grid.zoom2 b
    on a.cell_gid = b.gid;

create index grid_ieca_agg_zoom2_json_cell_gid
on poblacion_processing.grid_ieca_agg_zoom2_json
...
drop table if exists temp.pob_zoom2_gridding;


-- Creates the temp data

create table temp.pob_zoom2_gridding as
...
from
    ...
    context_grid.zoom2 a inner join
...
from poblacion_processing.grid_ieca_agg_zoom2_json;
=======
        dat0
    )::cell__cell
))
