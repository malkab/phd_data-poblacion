/*
    ...
    Grids the zoom 7 of population
...
drop table if exists temp.pob_zoom7_gridding;


-- Creates the temp data

create table temp.pob_zoom7_gridding as
...
from
    ...
    context_grid.zoom7 a inner join
